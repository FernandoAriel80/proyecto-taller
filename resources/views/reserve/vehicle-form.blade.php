        ...
        @if ($vehicles->isEmpty())
            <form action="{{ route('reserve.store') }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        <div class="mb-4">
                            <label for="current_mileage" class="block text-gray-200 mb-2">Kilometraje actual</label>
                        ...
                        <div class="mb-4">
                            <label for="fuel_type" class="block text-gray-200 mb-2">Tipo de combustible <br> (Nafta,
                                Diésel, Híbrido, Eléctrico)</label>
            ...
            <div>
                <form action="{{ route('reserve.create') }}" method="GET">
                    <div class="mb-4">
                        <label for="vehicles" class="block text-gray-200 mb-2">Seleccione uno de tus
                            vehículo</label>
                        <select id="vehicles" name="vehicle_id" class="w-full px-4 py-2 rounded bg-gray-500 text-white"
                ...
                <form action="{{ route('reserve.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            <div class="mb-4">
                                <label for="current_mileage" class="block text-gray-200 mb-2">Kilometraje
                                    actual</label>
                                <input type="text" id="current_mileage" name="current_mileage"
                            ...
                            <div class="mb-4">
                                <label for="fuel_type" class="block text-gray-200 mb-2">Tipo de combustible <br>
                                    (Nafta, Diésel, Híbrido, Eléctrico)</label>
                                <input type="text" id="fuel_type" name="fuel_type"
