...
<section>
    <nav
        ...
        <div>
            <a class="flex w-full hover:bg-slate-400 p-1 rounded-sm justify-center" href="{{ route('followUp.details.general.data.show',$current_id) }}">Información</a>
        </div>
        <div>
            <a class="flex w-full hover:bg-slate-400 p-1 rounded-sm justify-center"
                href="{{ route('followUp.details.report',$current_id) }}">Reporte</a>
        </div>
        <div>
            <a class="flex w-full hover:bg-slate-400 p-1 rounded-sm justify-center" href="{{ route('followUp.details.notes',$current_id) }}">Notas</a>
        </div>
       {{--  <div>
