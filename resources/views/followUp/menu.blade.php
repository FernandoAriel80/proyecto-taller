...
<body class="font-sans text-gray-900 antialiased bg-black">
    <div class="min-h-screen flex flex-col justify-center items-center pt-6 sm:pt-0">
        ...
        <div class="bg-gray-900 shadow-lg rounded-lg p-6 w-80 text-center">
            <h1 class="text-2xl font-bold text-gray-100 mb-4">Menú Seguimiento</h1>
            <nav class="flex flex-col space-y-3">
                <a href="{{ route('followUp.index') }}" class="text-lg font-medium text-gray-300 hover:text-white">Reservas Realizadas</a>
