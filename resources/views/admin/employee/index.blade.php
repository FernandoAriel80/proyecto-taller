                        ...
                        <div>
                            <form action="{{ route('employee.index') }}" method="GET">
                                ...
                                <input type="search" class="rounded-md" name="search" value="{{ request('search') }}"
                                    placeholder="Buscar">
                                <button type="submit"
                                    class="p-2 bg-red-600 hover:bg-red-700 rounded-md ">Buscar</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div id="modalCreate"
                        ...
                        <div class="bg-gray-700 p-6 rounded-lg shadow-lg w-96">
                            ...
                            <form action="#" method="POST" class="m-5">
                                ...
                                <x-input-modal name="password_confirmation" type="password"
                                    ...
                                    <tbody>
                                        @foreach ($employees as $employee)
                                            <tr class="hover:bg-gray-50 transition-colors border-b border-gray-200">
                                                ...
                                                <td>
                                                    <button
                                                        class="p-1 bg-blue-600 hover:bg-blue-700 text-white rounded-md">
                                                        <a
                                                            href="{{ route('employee.edit', [$employee->id]) }}">Actualizar</a>
                                                    </button>
