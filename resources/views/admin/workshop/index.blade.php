    ...
    <div class="grid grid-cols-8 h-screen">
        ...
        <div class="col-span-7 bg-slate-700 p-6">
            <div class="flex flex-col mx-auto max-w-6xl">
                ...
                <section>
                    <div class="grid md:grid-cols-2 grid-rows-2 gap-2  p-2 min-h-[300px] bg-back text-white">
                        ...
                        <div class="grid grid-cols-2 rounded-sm gap-2 p-2 row-span-2 bg-slate-500">
                            <section>
