...
<section>
    <nav
        ...
        <div>
            <a class="hover:bg-slate-400 p-1 rounded-sm" href="{{ route('workshop.general.data.show',$current_id) }}">Información</a>
        </div>
        <div>
        ...
        <div>
            <a class="hover:bg-slate-400 p-1  rounded-sm" href="{{ route('workshop.employee.note.show',$current_id) }}">Notas</a>
        </div>
       {{--  <div>
